...
def upload_video():
    ...
    # Get top 3 music AND detected emotion
    top3_music, video_emotion = get_top3_music_for_video(video_path)

    # Print emotion to server console
    print(f" Detected emotion for video '{file.filename}': {video_emotion}")

    # Return top 3 music as usual
